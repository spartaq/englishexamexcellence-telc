      ...
      tasks: [
        ...
        },
        {
          ...
          words: [
            ...
            { term: 'Carbon footprint', hu: 'Szénlábnyom', definition: 'The total greenhouse gas emissions caused by a person or organization.', example: 'Reducing your carbon footprint helps the environment.' },
            { term: 'Emission', hu: 'Kibocsátás', definition: 'The production and release of gases into the atmosphere.', example: 'Vehicle emissions contribute to air pollution.' },
      ...
      tasks: [
        ...
        },
        {
          ...
          words: [
            ...
            { term: 'Market', hu: 'Piac', definition: 'A platform where buyers and sellers trade goods and services.', example: 'The technology market is very competitive.' },
            { term: 'Company', hu: 'Vállalat', definition: 'A business organization that sells products or services.', example: 'She works for a multinational company.' },
      ...
      tasks: [
        ...
        },
        {
          ...
          words: [
            ...
            { term: 'Curriculum development', hu: 'Tantervfejlesztés', definition: 'The process of designing and improving educational courses.', example: 'Curriculum development requires teacher input.' },
            { term: 'Cognitive development', hu: 'Kognitív fejlődés', definition: 'The construction of thought processes including remembering and problem-solving.', example: 'Early education affects cognitive development.' },
            { term: 'Educational policy', hu: 'Oktatáspolitika', definition: 'Government decisions about education systems.', example: 'Educational policy varies between countries.' },
            { term: 'Lifelong learning', hu: 'Egész életen át tartó tanulás', definition: 'Continuous education throughout a person\'s life.', example: 'Lifelong learning is essential in today\'s job market.' },
            { term: 'Academic achievement', hu: 'Akademikus teljesítmény', definition: 'Success in educational pursuits.', example: 'The program aims to improve academic achievement.' },
            { term: 'Pedagogical approach', hu: 'Pedagógiai megközelítés', definition: 'Methods and strategies used in teaching.', example: 'Each teacher has their own pedagogical approach.' },
            { term: 'Didactic', hu: 'Didaktikus', definition: 'Intended to teach or instruct.', example: 'The textbook has a didactic purpose.' },
            { term: 'Efficacy', hu: 'Hatékonyság', definition: 'The ability to produce a desired result.', example: 'Researchers studied the efficacy of the teaching method.' }
          ]
        }
      ]
    },
    {
      ...
      tasks: [
        ...
        },
        {
          ...
          level: 'C1',
          words: [
            { term: 'Pathophysiology', hu: 'Patofiziológia', definition: 'The study of how diseases affect body functions.', example: 'Understanding pathophysiology helps treat diseases.' },
            { term: 'Epidemiology', hu: 'Járványtan', definition: 'The study of disease distribution and control.', example: 'Epidemiology tracks disease outbreaks.' },
            { term: 'Chronobiology', hu: 'Kronobiológia', definition: 'The study of biological rhythms.', example: 'Chronobiology研究睡眠周期。' },
            { term: 'Psychopathology', hu: 'Pszichopatológia', definition: 'The study of mental disorders.', example: 'Psychopathology examines the causes of mental illness.' },
            { term: 'Neurotransmitter', hu: 'Neurotranszmitter', definition: 'Chemicals that transmit signals in the brain.', example: 'Serotonin is an important neurotransmitter.' },
            { term: 'Immunodeficiency', hu: 'Immunhiány', definition: 'The inability to fight off infections.', example: 'HIV causes immunodeficiency.' },
            { term: 'Cardiovascular', hu: 'Kardiovaszkuláris', definition: 'Relating to the heart and blood vessels.', example: 'Cardiovascular disease is a leading cause of death.' },
            { term: 'Metabolic syndrome', hu: 'Metabolikus szindróma', definition: 'A cluster of conditions increasing disease risk.', example: 'Obesity is linked to metabolic syndrome.' },
            { term: 'Holistic approach', hu: 'Holisztikus megközelítés', definition: 'Treating the whole person, not just symptoms.', example: 'Holistic approaches consider mental and physical health.' },
            { term: 'Pharmacology', hu: 'Farmakológia', definition: 'The study of drug action and effects.', example: 'Pharmacology is essential for developing new medicines.' },
            { term: 'Etiology', hu: 'Etiológia', definition: 'The cause or set of causes of a disease.', example: 'Researchers study the etiology of cancer.' },
            { term: 'Biomarker', hu: 'Biomarker', definition: 'A measurable indicator of biological state.', example: 'Blood tests can detect biomarkers for disease.' }
          ]
        }
      ]
    },
      ...
      tasks: [
        ...
        },
        {
          ...
          words: [
            ...
            { term: 'Photosynthesis', hu: 'Fotoszintézis', definition: 'The process by which plants make food using sunlight.', example: 'Photosynthesis produces oxygen.' },
            ...
            { term: 'Atmosphere', hu: 'Légkör', definition: 'The layer of gases surrounding the Earth.', example: 'The atmosphere protects us from harmful radiation.' },
      ...
      tasks: [
        {
          ...
          words: [
            ...
            { term: 'Goal (score)', hu: 'Cél', definition: 'Points scored in a game.', example: 'We scored a goal.' },
            ...
            { term: 'Goal (place)', hu: 'Kapu', definition: 'The place where you score.', example: 'The ball went in the goal.' },
        ...
        },
        {
          ...
          words: [
            ...
            { term: 'Spectatorship', hu: 'Nézőség', definition: 'The act of watching sporting events.', example: 'Modern spectatorship includes digital streaming.' },
            { term: 'Commercialization', hu: 'Kereskedelmi hasznosítás', definition: 'The process of making something commercially successful.', example: 'The commercialization of sports has changed the games.' },
            { term: 'Nostalgia', hu: 'Nosztalgia', definition: 'A sentimental longing for the past.', example: 'The Olympics evoke nostalgia for past achievements.' },
            { term: 'Geopolitical', hu: 'Geopolitikai', definition: 'Relating to politics and international relations.', example: 'Hosting the Olympics has geopolitical implications.' },
            { term: 'Socioeconomic', hu: 'Társadalmi-gazdasági', definition: 'Relating to both social and economic factors.', example: 'The event has socioeconomic impacts on the host city.' },
            { term: 'Urban development', hu: 'Városfejlesztés', definition: 'The growth and improvement of cities.', example: 'Major events drive urban development.' },
            { term: 'Athletics', hu: 'Atlétika', definition: 'Sporting activities involving physical competition.', example: 'Athletics include running, jumping, and throwing events.' }
          ]
        }
      ]
    },
      ...
      tasks: [
        ...
        },
        {
          ...
          words: [
            ...
            { term: 'Communication', hu: 'Kommunikáció', definition: 'The exchange of information between people.', example: 'Modern communication is instant and global.' }
          ]
        },
        {
          id: 'v_history_c1',
          ...
          words: [
            ...
            { term: 'Civilization', hu: 'Civilizáció', definition: 'A complex human society with developed culture and institutions.', example: 'Ancient civilizations left lasting legacies.' },
            { term: 'Industrialization', hu: 'Industrializáció', definition: 'The development of industries in a country or region.', example: 'Industrialization transformed society in the 19th century.' },
            { term: 'Colonization', hu: 'Gyarmatosítás', definition: 'The process of establishing control over another country.', example: 'Colonization had lasting effects on global politics.' },
            { term: 'Historical evidence', hu: 'Történelmi bizonyíték', definition: 'Physical proof from the past.', example: 'Archaeologists uncover historical evidence.' },
            { term: 'Chronology', hu: 'Kronológia', definition: 'The arrangement of events in time order.', example: 'Understanding chronology helps us understand history.' },
            { term: 'Archival', hu: 'Archív', definition: 'Relating to the preservation of historical records.', example: 'Archival documents provide valuable insights.' },
            { term: 'Anthropological', hu: 'Antropológiai', definition: 'Relating to the study of human societies and cultures.', example: 'Anthropological research reveals cultural patterns.' },
            { term: 'Historiography', hu: 'Történetírás', definition: 'The writing of history and methods of studying it.', example: 'Historiography has evolved over time.' },
